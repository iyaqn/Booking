...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div class="row" id="policies">
                        <div class="col-md-4">
                            ...
                            <p class="rules">
                                Please check the <a href="faq.php">FAQs</a> page for the rules and regulations.
                                Contact us through <a href="https://www.facebook.com/villadelosreyesresort" target="_blank">Facebook</a> or through our <a href="mailto:villadelosreyes@yahoo.com" target="_blank">email</a> for concerns.
                            </p>
                        </div>
                        <div class="col-md-8">
                            <!-- Includsion -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="proofOfPayment" accept="image/png, image/gif, image/jpeg" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dateSent" required required min="<?php echo date('Y-m-d');?>">
                            </div>
                        </div>
                    </div>
                    <hr />
    ...
    $(document).ready(function() {
        function getDateStatus(dateStr, events) {
    for (const event of events) {
        if (event.start === dateStr) {
            return event.title === 'Reserved' ? 'Reserved' : 'Pending';
        }
    }
    return 'Available';
}
        ...
        success: function(res) {
            ...
            calendar.on('dateClick', function(info) {
                ...
                if (selectedDate <= currentDate) {
                  ...
                  // Get the status of the selected date
                var dateStatus = getDateStatus(dateStr, events);
                ...
                switch (dateStatus) {
                    case 'Reserved':
                        ...
                        break;
                    case 'Pending':
                        alert('This date is pending for reservations. Please choose another date.');
                        break;
                    case 'Available':
...
$(document).ready(function() {
    // Set min attribute dynamically to restrict date selection to today and future dates
    var today = new Date().toISOString().split('T')[0];
    $('#dateSent').attr('min', today);
